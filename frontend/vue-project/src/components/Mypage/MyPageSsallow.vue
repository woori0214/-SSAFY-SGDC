<template>
  <div>
    ...
    <transition name="fade">
      <div class="accordion-content-ssallow" v-if="isOpen">
        <div class="sallowing_body">
          ...
          >
            ...
            <div class="ssallow_btns">
              <button
                @click="gotoProfile(ssallowing.userId)"
                class="ssallow_btn"
              >
                프로필 페이지
              </button>
        ...
        <div class="ssallower_body">
          ...
          >
            ...
            <div class="ssallow_btns">
              <button
                @click="gotoProfile(ssallower.userId)"
                class="ssallow_btn"
              >
                프로필 페이지
              </button>
